...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    if (utenteLoggato) {
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"UtenteLoggato"];
    }
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"RiportaSpazioAderenteAlBenvenuto" object:nil];
}
